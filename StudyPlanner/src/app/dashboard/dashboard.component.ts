...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.studentExams = [
      {id: "INF001", name: "Analisi Matematica II", cfu: 6, completed: true, note: "Propedeutico Analisi Matematica I"},
  ...
  private calculateStudentMetrics(): void{
    ...
    this.totalCfu = this.studentExams.filter(exam => exam.completed).reduce((sum, exam) => sum+exam.cfu, 0);
